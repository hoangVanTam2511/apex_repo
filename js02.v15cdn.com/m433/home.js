...
function homeBannerSwiper() {
  if ($("#indexbanner").length) {
    if ($("#indexbanner .swiper-slide").length < 2) {
      $(".bannerswiper-next,.bannerswiper-prev").hide();
    }
...
homeBannerSwiper();
function homenum() {
  $(window).on("scroll.num", function () {
    if (
      $(".home-num").length &&
      $(this).scrollTop() >
        $(".home-num").offset().top - $(window).height() + 100
    ) {
      anitNum();
      $(window).off("scroll.num");
    }
  });
  function anitNum() {
    $(".homenum-icon").each(function (i) {
      changeNum($(this), 1500, i);
    });
    function changeNum($ele, time, index) {
      ...
      $({ n: 1 }).animate(
        { n: num },
        {
          duration: time,
          step: function () {
            $ele.html(parseInt(this.n) + (index === 0 ? "" : ""));
          },
          complete: function () {
            $ele.html(parseInt(this.n) + (index === 0 ? "" : ""));
          },
...
function serviceswiper() {
  if ($("#serviceswiper").length > 0) {
    var serviceswiper = new Swiper("#serviceswiper", {
      slidesPerView: 4,
      spaceBetween: 20,
      pagination: { el: ".serviceswiper-pagination", clickable: true },
      navigation: {
...
function advantageswiper() {
  if ($("#advantageswiper").length > 0) {
    var advantageswiper = new Swiper("#advantageswiper", {
      slidesPerView: 4,
      spaceBetween: 20,
      pagination: { el: ".advantageswiper-pagination", clickable: true },
      breakpoints: {
        0: { slidesPerView: 1 },
        500: { slidesPerView: 2 },
        1024: { slidesPerView: 4 },
...
function homelogoswiper() {
  if ($("#logoswiper").length) {
    var logoswiper = new Swiper("#logoswiper", {
      ...
      pagination: { el: ".logoswiper-pagination" },
      freeMode: true,
      breakpoints: {
        0: { slidesPerView: 3 },
        500: { slidesPerView: 4 },
...
function customerswiper() {
  if ($("#customerswiper").length > 0) {
    var customerswiper = new Swiper("#customerswiper", {
      slidesPerView: 1,
      pagination: { el: ".customerswiper-pagination", clickable: true },
    });
  }
}
customerswiper();
function videoswiper() {
  if ($("#videoswiper").length > 0) {
    var videoswiper = new Swiper("#videoswiper", {
      slidesPerView: 3,
      spaceBetween: 20,
      pagination: { el: ".videoswiper-pagination", clickable: true },
      breakpoints: {
...
function newswiper() {
  if ($("#newswiper").length > 0) {
    var newswiper = new Swiper("#newswiper", {
      slidesPerView: 4,
      spaceBetween: 10,
      pagination: { el: ".newswiper-pagination", clickable: true },
      breakpoints: {
        0: { slidesPerView: 1, spaceBetween: 10 },
        500: { slidesPerView: 2, spaceBetween: 10 },
